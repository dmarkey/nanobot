...
class AgentLoop:
    ...
    def __init__(
        ...
        self.subagent_max_iterations = (
            ...
            if subagent_max_iterations is not None
        ...
        self.subagents = SubagentManager(
            ...
            default_max_iterations=self.subagent_max_iterations,
        ...
        self.register_runtime_context_provider(self._session_runtime_context)
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        return cls(
            ...
            subagent_max_iterations=defaults.subagent_max_iterations,
    ...
    def _register_default_tools(
        ...
        *,
        ...
        if self._deferred_loading:
            ...
            registered.append("resolve_tools")
    ...
    async def _session_runtime_context(
        self,
        request: RequestContext,
    ) -> RuntimeContextResult:
        """Base runtime metadata (time/channel/sender) plus voice-channel guidance."""
        return self.context.build_session_runtime_block(
            request.channel,
            request.chat_id,
