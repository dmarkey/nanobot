...
OpenAI Whisper, OpenRouter, Xiaomi MiMo ASR, Zhipu, and AssemblyAI. Product-level
config fallback, WebUI upload validation, and channel integration live in
...
class ZhipuTranscriptionProvider:
    ...
    def __init__(
        ...
        self.api_url = _resolve_transcription_url(
            api_base or os.environ.get("ZHIPU_BASE_URL"),
            "https://open.bigmodel.cn/api/paas/v4/audio/transcriptions",
        )
        self.language = language
        self.model = model or "glm-asr-2512"
