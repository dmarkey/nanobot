...
class ChannelManager:
    ...
    def _build_channel(
        ...
        *,
        ...
        channel.transcription_api_key = self._resolve_transcription_key(transcription_provider)
        channel.transcription_api_base = self._resolve_transcription_base(transcription_provider)
        channel.transcription_language = self.config.channels.transcription_language
        channel.zhipu_api_key = self._resolve_zhipu_key()
        return channel
